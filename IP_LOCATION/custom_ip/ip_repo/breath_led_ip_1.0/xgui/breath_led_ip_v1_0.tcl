...
proc update_PARAM_VALUE.CNT_2MS_MAX { PARAM_VALUE.CNT_2MS_MAX } {
	# Procedure called to update CNT_2MS_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CNT_2MS_MAX { PARAM_VALUE.CNT_2MS_MAX } {
	# Procedure called to validate CNT_2MS_MAX
	return true
}

proc update_PARAM_VALUE.CNT_2S_MAX { PARAM_VALUE.CNT_2S_MAX } {
	# Procedure called to update CNT_2S_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CNT_2S_MAX { PARAM_VALUE.CNT_2S_MAX } {
	# Procedure called to validate CNT_2S_MAX
	return true
}

proc update_PARAM_VALUE.CNT_2US_MAX { PARAM_VALUE.CNT_2US_MAX } {
	# Procedure called to update CNT_2US_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CNT_2US_MAX { PARAM_VALUE.CNT_2US_MAX } {
	# Procedure called to validate CNT_2US_MAX
	return true
}
...
proc update_MODELPARAM_VALUE.CNT_2US_MAX { MODELPARAM_VALUE.CNT_2US_MAX PARAM_VALUE.CNT_2US_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CNT_2US_MAX}] ${MODELPARAM_VALUE.CNT_2US_MAX}
}

proc update_MODELPARAM_VALUE.CNT_2MS_MAX { MODELPARAM_VALUE.CNT_2MS_MAX PARAM_VALUE.CNT_2MS_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CNT_2MS_MAX}] ${MODELPARAM_VALUE.CNT_2MS_MAX}
}

proc update_MODELPARAM_VALUE.CNT_2S_MAX { MODELPARAM_VALUE.CNT_2S_MAX PARAM_VALUE.CNT_2S_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CNT_2S_MAX}] ${MODELPARAM_VALUE.CNT_2S_MAX}
}
