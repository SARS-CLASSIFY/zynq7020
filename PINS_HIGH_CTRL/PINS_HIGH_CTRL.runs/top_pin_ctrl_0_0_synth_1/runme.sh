...
HD_PWD='C:/Users/86150/Desktop/08_ps_uart/ps_uart.runs/top_pin_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pin_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pin_ctrl_0_0.tcl
