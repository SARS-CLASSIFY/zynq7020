...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ps_uart.srcs/sources_1/bd/top/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../ps_uart.srcs/sources_1/bd/top/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../ps_uart.srcs/sources_1/bd/top/ipshared/1313/hdl" \
       +incdir+"../../../../ps_uart.srcs/sources_1/bd/top/ipshared/ec67/hdl" \
       +incdir+"../../../../ps_uart.srcs/sources_1/bd/top/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../ps_uart.srcs/sources_1/bd/top/ipshared/1313/hdl" \
       +incdir+"F:/Xilinx/Vivado/2017.4/data/xilinx_vip/include"
}
